...
%token NUM OPER1 OPER2 ID BOOL INT BNUM MAIN BEGN END DECL ENDDECL ASG READ PRINT RELOP LOGOP NEGOP IF ELSE THEN ENDIF WHILE DO ENDWHILE RETURN
%type<n> stmtlist param stmt expr ids fID Body NUM BNUM OPER1 OPER2 ID ASG READ PRINT RELOP LOGOP NEGOP IF WHILE RETURN
